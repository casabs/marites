...
<?php
    ...
    define('TITLE',"Dashboard| marites");
...
?> 
    ...
    <body onload="pageLoad()">
        ...
        <img src='img/marites_logo_2.png' id='loader-logo';>
            <div class="loader">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7" >
                        ...
                        <div class="text-center p-3">
                            <img src="img/marites-lw.png"><br>
                            <h2 style= "font-color: black;">D  A  S  H  B  O  A  R  D</h2>
                            <br><br>
                        </div>
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="forum" role="tabpanel" aria-labelledby="forum-tab">
                                ...
                                <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                                    <img class="mr-3" src="img/logo_lc.png" alt="" width="60" height="60">
                                  <div class="lh-100">
                                    <h1 class="mb-0 text-white lh-100">Latest Chikas</h1>
                                  </div>
                                </div>  
                    ...
                    <div class="col-sm-2"><br>
                        ...
                        <br><a href="hub.php" class="btn btn-warning btn-lg btn-block" style="background-color: #004374; color: #FFCE0A;"><b>THE MARITES HUB</b></a><br><hr>
                        <br><br><br>
                        <a href="forum.php" class="btn btn-warning btn-lg btn-block" style="background-color: #004374;">Forums</a>
                        <a href="blogs.php" class="btn btn-warning btn-lg btn-block" style="background-color: #004374;">Blogs</a>
                        <a href="polls.php" class="btn btn-warning btn-lg btn-block" style="background-color: #004374;">Polls</a>
                        <a href="events.php" class="btn btn-warning btn-lg btn-block" style="background-color: #004374;">Events</a>
                        <br><br><br>
                        <hr><br><a href="create-topic.php" class="btn btn-warning btn-lg btn-block" style="background-color: #FFCE0A;">Create a Forum</a>
                        <a href="create-blog.php" class="btn btn-warning btn-lg btn-block" style="background-color: #FFCE0A;">Create a Blog</a>
                        <a href="create-poll.php" class="btn btn-warning btn-lg btn-block" style="background-color: #FFCE0A;">Create a Poll</a>
                        <a href="create-event.php" class="btn btn-warning btn-lg btn-block" style="background-color: #FFCE0A;">Create an Event</a>   
                        <br><br><br><br><br><br>
                        <div class="text-center p-3 mt-10">
                            <a href="team.php" target="_blank">
                            <img src='img/creators_logo.png' id='logo';>
                            </a>
                            <h2 style="color: #004374;"><b>THE CREATORS</b></h2>
