      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-8 text-center" id="user-section">
              <img class="cover-img" src="img/profile-banner.png">
              <img class="profile-img" src="uploads/<?php echo $user['userImg']; ?>">
              
              <?php  
                    if ($user['userLevel'] === 1)
                    {
                        echo '<img id="admin-badge" src="img/admin_badge.png">';
                    }
              ?>
              ...
              <?php 
                ...
                ?>
              <br><br><hr><br>
              <b><h2 class = chismis style="font-size: 15px; color: #004374;"> MOTTO OF A CHISMOSA </h2></b>
              <small><?php echo $user['headline']; ?></small>
              <br><br>

              <div class="profile-bio">
              <b><h2 class = chismis style= "text-align: center; font-size: 15px; color: #004374;"> MARITES' BIO: </h2></b> 
                    ...
                    else
                    {
                        ...
                        if(empty($row))
                        {
                            echo '<div class="col-sm-4" style="padding-bottom: 30px;"></div>
                                <div class="col-sm-4">
                                    <img class="profile-empty-img" src="img/no_chismis.png">
                                  </div>
