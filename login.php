    ...
    <section id="cover">
        <div id="cover-caption">
            <div class="container">
                ...
                <img src="img/marites_logo_2.png" height="350" width="350">
                    <h5 class="text-white">Humayo kayo at makichismis.</h5>
                    <br><br><br>
                    <?php
                    ...
                    <form method="post" action="includes/login.inc.php" class="form-inline justify-content-center">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="password" name="pwd"
                                   class="form-control form-control-lg mr-1" placeholder="Password">&emsp;
                        </div> 
                        <input type="submit" class="btn btn-dark btn-lg mr-1" style="background-color: #FFCE0A;" name="login-submit" value="Login">
                    </form> <br> <br><br>
                    <br><br><a href="signup.php" class="btn btn-light btn-lg mr-1" style="font-size: 10px;">Create a new account?</a>
