<?php
    ...
    define('TITLE',"Create Blog | marites");
						...
						Create a Blog
                                        ...
                                        <?php
                                            if(isset($_GET['error']))
                                            {
                                                ...
                                                {
                                                    echo '<h5 class="text-danger">*A blog with the given name already exists</h5>';
                                                }
                                            ...
                                            {
                                                echo '<h5 class="text-success">*Blog successfully created</h5>';
                                            }
                                        ?>
                                        </span>
