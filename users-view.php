<?php
    ...
    define('TITLE',"Find People | marites");
        ...
        <main role="main" class="container">
            <div class="mx-5">
                <div class="d-flex align-items-center p-3 my-3 mx-5 text-white-50 bg-purple rounded shadow-sm">
                  ...
                  <div class="lh-100">
                    <h1 class="mb-0 text-white lh-100">Chismosas</h1>
                    <small>Spreading Chika</small>
                  </div>
                </div>

                <div class="my-3 mx-5 p-3 bg-white rounded shadow-sm">
                  <h5 class="border-bottom border-gray pb-2 mb-0">Find a Marites</h5>
                  ...
                  ?>
                      ...
                      <small class="d-block text-right mt-3">
                          <a href="profile.php" class="btn btn-primary" style="background-color: #004374;">Your Profile</a>
                          <a href="message.php" class="btn btn-primary" style="background-color: #FFCE0A;">Your Inbox</a>
                      </small>
