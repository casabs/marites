                            ...
                            <div class="chat_people">
                              ...
                              <div class="chat_ib">
                                <h5>
                                    ...
                                    <span class="chat_date">Marites User</span>
                                </h5>
                                <p>Click on a Marites to start chatting.</p>
                              </div>
                            </div>
                          </div></a>
                ...
                <div class="type_msg">
                    <div class="input_msg_write">
                        ...
                        <textarea id="message" type="text" class="write_msg form-control-plaintext" style="background-color: white;" 
                                  placeholder="Type a message, then click the send button."></textarea>

                        <button id="reply" class="msg_send_btn" type="button">
