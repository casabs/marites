...
?>  
    ...
    <body style="background: #f1f1f1">
      ...
      <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
        ...
        <div class="lh-100">
          <h1 class="mb-0 text-white lh-100">Marites Hub</h1>
                    ...
                    echo '<a href="blog-page.php?id='.$row['blog_id'].'">
                        <div class="media text-muted pt-3">
                            ...
                            <span class="text-right text-primary"><i class="fa fa-thumbs-up" aria-hidden="true"></i>
                                ...
                                if ($_SESSION['userLevel'] == 0 || $_SESSION['userLevel'] == 1 || $_SESSION['userLevel'] == $row['blog_by']) 
            ...
            else
            {
                ...
                while ($row = mysqli_fetch_assoc($result))
                {
                    ...
                    echo '<a href="poll.php?poll='.$row['id'].'">
                        <div class="media text-muted pt-3">
                            <img src="img/poll_cover.png" alt="" class="mr-2 rounded div-img">
                            <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
