...
?>  
    ...
    <body style="background: #f1f1f1">
        ...
        <div><br><br>
        <a href="hub.php" class="btn btn-warning btn-lg btn-block" style="background-color: #004374; color: #FFCE0A;"><b>THE MARITES HUB</b></a><br><hr>
        </div>

        <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
          <img class="mr-3" src="img/marites_logo.png" alt="" width="48" height="48">
        <div class="lh-100">
          <h1 class="mb-0 text-white lh-100">Marites Forums</h1>
          <small>Spreading Chismis</small>
        </div>
      </div>
      ...
      <div class="my-3 p-3 bg-white rounded shadow-sm">
        ...
        <?php
                ...
                while ($row = mysqli_fetch_assoc($result))
                {
                    ...
                    echo '<a href="topics.php?cat='.$row['cat_id'].'">
                        <div class="media text-muted pt-3">
                            <img src="img/forum_cover.png" alt="" class="mr-2 rounded div-img ">
            ...
            if ($_SESSION['userLevel'] == 1)
            {
                echo '<small class="d-block text-right mt-3">
                        <a href="create-category.php" class="btn btn-primary" style ="background-color: #004374">Create Category</a>';
            }
            else
            {
                echo '<small class="d-block text-right mt-3">';
        ...
        ?>
            ...
            <a href="categories.php" class="btn btn-primary" style ="background-color: #004374">All Categories</a>
        </small>
      ...
      <div class="my-3 p-3 bg-white rounded shadow-sm">
        ...
        <small class="d-block text-right mt-3">
            <a href="create-topic.php" class="btn btn-primary" style ="background-color: #004374">Create A Forum</a>
            <a href="topics.php" class="btn btn-primary" style ="background-color: #004374">All Forums</a>
        </small>
