<?php
    ...
    define('TITLE',"Edit Profile | marites");
    ...
    <?php include 'includes/navbar.php'; ?>
      <div class="container">
        ...
        <div class="col-sm-8 text-center" id="user-section">
              ...
              <img class="cover-img" id='blah-cover' src="img/profile-banner.png">
              
              <form action="includes/profileUpdate.inc.php" method='post' enctype="multipart/form-data"
                    style="padding: 0 30px 0 30px;"><br>
                  ...
                  <br><br><label class="btn btn-primary">
                    ...
                    <h2><br><?php echo strtoupper($_SESSION['userUid']); ?></h2><br>
